...
pub fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::refresh_theme_market,
            commands::install_theme,
            commands::test_stepwise_settings,
            commands::generate_stepwise,
            commands::inspect_relay_environment,
            ...
            commands::inspect_plugin_configuration,
            commands::repair_plugin_configuration,
            commands::restore_plugin_configuration_backup,
