...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read CodexX Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse CodexX Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write CodexX Zed remote project registry")]
