...
pub fn inspect_relay_environment() -> RelayEnvironmentReport {
    ...
    let clash_verge_candidates = [
        ...
        directories::BaseDirs::new()
            .map(|dirs| dirs.home_dir().join("AppData/Local/Clash Verge Rev"))
            .unwrap_or_default(),
    ]
    .into_iter()
    ...
    RelayEnvironmentReport {
        proxy_variables,
        codex_env_path: env_path.to_string_lossy().to_string(),
        codex_env_exists: env_path.exists(),
        clash_verge_candidates,
    }
}
