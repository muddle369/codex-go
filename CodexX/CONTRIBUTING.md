# Contributing to CodexX

Thank you for your interest in contributing to CodexX!

## Development Setup

1. **Clone the repository**
   ```bash
   git clone https://github.com/muddle369/CodexX.git
   cd CodexX
   ```
...
CodexX/
├── crates/
│   ├── codexx-data/    # Data handling and provider sync
│   └── codexx-core/    # Core CodexX logic
